class PetHistoriesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @pet_history.save
        format.html { redirect_to pet_history_url(@pet_history), notice: "Historial de Mascota creado exitosdamente." }
  ...
  def update
    respond_to do |format|
      if @pet_history.update(pet_history_params)
        format.html { redirect_to pet_history_url(@pet_history), notice: "Historial de Mascota editado exitosamente." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to pet_histories_url, notice: "Historial de Mascota eliminado exitosamente." }
  ...
  private
    ...
    def pet_history_params
      params.require(:pet_history).permit(:height, :weight, :dateVisit, :diagnosis, :pet_id)
    end
end
